...
export class RecipeEditComponent implements OnInit, OnDestroy {
  ...
  get ProductsControls() {
    return (this.recipeForm.get('products') as FormArray).controls;
  }
  ...
  onAddProducts() {
    (<FormArray>this.recipeForm.get('products')).push(
      new FormGroup({
        name: new FormControl(null, Validators.required),
        amount: new FormControl(null, [
          Validators.required,
  ...
  onDeleteProduct(index: number) {
    (<FormArray>this.recipeForm.get('products')).removeAt(index);
  }
  ...
  private initForm() {
    ...
    let recipeProducts = new FormArray([]);
